...
\newcommand{\dataselectiontime}{\todo{} hours (\todo{} spacecraft spins) }
\newcommand{\backscattertime}{\todo{} hours (\todo{} spacecraft spins) }
...
\todo{removed segments w 0 loss cone flux}
...
The process of simulating the backscatter of ELFIN-measured particle distributions was repeated for all data segments that were analyzed in Section \ref{section:data-backscatter}. For each event, the total anti-loss cone electron counts predicted by our simulation scheme was divided by the measured anti-loss cone electron count, providing a statistic by which we may evaluate the performance of our simulation. These ratios are shown in Figure \ref{figure:data-model-comparison}.
