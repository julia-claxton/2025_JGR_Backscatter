...
\begin{figure}[H]
  \centering
  \noindent\includegraphics[width=0.8\textwidth]{figures/supplemental_curves.png}
  \caption{
...
\begin{align*}
r_N &= 0.068299421 \cdot \left( \frac{J_\text{precip}}{J_\text{trap}} \right)^{-0.73878583} & R^2 = 0.99336882 \\
r_E &= 0.05627575 \cdot \left( \frac{J_\text{precip}}{J_\text{trap}} \right)^{-0.84640575} & R^2 = 0.98450499
\end{align*}
...
\begin{figure}[H]
  \centering
  \noindent\includegraphics[width=0.8\textwidth]{figures/supplemental_curvefit.png}
  \caption{
...
\newpage
\section{Energy Backscatter Residuals}
ELFIN-derived energy backscatter plotted against simulation-predicted energy backscatter is shown below.

\begin{figure}[H]
  \centering
  \noindent\includegraphics[width=0.7\textwidth]{figures/supplemental_data_model.png}
  \caption{
    Anti-loss cone energy flux predicted by lookup tables derived from our Monte Carlo simulation vs. ELFIN-measured anti-loss cone energy for all ELFIN data segments that were simulated. The dashed white line indicates where predicted backscatter was equal to ELFIN-measured backscatter.
  }
