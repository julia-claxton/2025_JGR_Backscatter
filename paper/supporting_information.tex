...
\begin{align*}
  r_N &= 0.040830269 \cdot \left( \frac{J_\text{precip}}{J_\text{trap}} \right)^{-0.79919772} & R^2 = 0.96791982 \\
  r_E &= 0.038590361 \cdot \left( \frac{J_\text{precip}}{J_\text{trap}} \right)^{-0.81686408} & R^2 = 0.98398356
\end{align*}
